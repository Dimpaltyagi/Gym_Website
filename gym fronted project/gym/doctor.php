<?php
	...
	$conn = new mysqli('localhost','root','','doctors');
	 if($conn->connect_error){
	 	...
	 	$stmt = $conn->prepare("insert into receipts(firstName, email, phnumber, trnumber, banumber) values(?, ?, ?, ?, ?)");
...
<body>
	...
	<h3>THANKS FOR CONNECTING WITH US, OUR DOCTOR TEAM CONTACT WITH YOU AS SOON AS POSSIBLE</h3>
